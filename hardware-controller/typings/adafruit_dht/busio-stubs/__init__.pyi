...
class I2C:
    ...
    def __init__(self, scl: microcontroller.Pin, sda: microcontroller.Pin, *, frequency: int = ..., timeout: int = ...) -> None:
    ...
    def readfrom_into(self, address: int, buffer: WriteableBuffer, *, start: int = ..., end: int = ...) -> None:
    ...
    def writeto(self, address: int, buffer: ReadableBuffer, *, start: int = ..., end: int = ...) -> None:
    ...
    def writeto_then_readfrom(self, address: int, out_buffer: ReadableBuffer, in_buffer: WriteableBuffer, *, out_start: int = ..., out_end: int = ..., in_start: int = ..., in_end: int = ...) -> None:
...
class SPI:
    ...
    """
    def __init__(self, clock: microcontroller.Pin, MOSI: Optional[microcontroller.Pin] = ..., MISO: Optional[microcontroller.Pin] = ..., half_duplex: bool = ...) -> None:
    ...
    def configure(self, *, baudrate: int = ..., polarity: int = ..., phase: int = ..., bits: int = ...) -> None:
    ...
    def write(self, buffer: ReadableBuffer, *, start: int = ..., end: int = ...) -> None:
    ...
    def readinto(self, buffer: WriteableBuffer, *, start: int = ..., end: int = ..., write_value: int = ...) -> None:
    ...
    def write_readinto(self, out_buffer: ReadableBuffer, in_buffer: WriteableBuffer, *, out_start: int = ..., out_end: int = ..., in_start: int = ..., in_end: int = ...) -> None:
...
class UART:
    ...
    """
    def __init__(self, tx: Optional[microcontroller.Pin] = ..., rx: Optional[microcontroller.Pin] = ..., *, rts: Optional[microcontroller.Pin] = ..., cts: Optional[microcontroller.Pin] = ..., rs485_dir: Optional[microcontroller.Pin] = ..., rs485_invert: bool = ..., baudrate: int = ..., bits: int = ..., parity: Optional[Parity] = ..., stop: int = ..., timeout: float = ..., receiver_buffer_size: int = ...) -> None:
