...
from builtins import bool as _bool, float as _float

"""Numerical approximation methods"""
def interp(x: ulab.numpy.ndarray, xp: ulab.numpy.ndarray, fp: ulab.numpy.ndarray, *, left: Optional[_float] = ..., right: Optional[_float] = ...) -> ulab.numpy.ndarray:
    """
...
def trapz(y: ulab.numpy.ndarray, x: Optional[ulab.numpy.ndarray] = ..., dx: _float = ...) -> _float:
    """
...
def clip(a: _ScalarOrArrayLike, a_min: _ScalarOrArrayLike, a_max: _ScalarOrArrayLike) -> _ScalarOrNdArray:
    """
...
def not_equal(x: _ScalarOrArrayLike, y: _ScalarOrArrayLike) -> Union[_bool, ulab.numpy.ndarray]:
    """
    Returns ``x != y`` element-wise.
...
def where(condition: _ScalarOrArrayLike, x: _ScalarOrArrayLike, y: _ScalarOrArrayLike) -> ulab.numpy.ndarray:
    """
...
@overload
def arange(stop: _float, step: _float = ..., *, dtype: _DType = ...) -> ulab.numpy.ndarray:
    ...

@overload
def arange(start: _float, stop: _float, step: _float = ..., *, dtype: _DType = ...) -> ulab.numpy.ndarray:
    """
    .. param: start
...
def concatenate(arrays: Tuple[ulab.numpy.ndarray], *, axis: int = ...) -> ulab.numpy.ndarray:
    """
    .. param: arrays
      tuple of ndarrays
    .. param: axis
...
def diag(a: ulab.numpy.ndarray, *, k: int = ...) -> ulab.numpy.ndarray:
    """
    .. param: a
      an ndarray
    .. param: k
...
def empty(shape: Union[int, Tuple[int, ...]], *, dtype: _DType = ...) -> ulab.numpy.ndarray:
    """
    .. param: shape
...
def eye(size: int, *, M: Optional[int] = ..., k: int = ..., dtype: _DType = ...) -> ulab.numpy.ndarray:
    """Return a new square array of size, with the diagonal elements set to 1
    and the other elements set to 0. If k is given, the diagonal is shifted by the specified amount.
    """
    ...

def full(shape: Union[int, Tuple[int, ...]], fill_value: Union[_float, _bool], *, dtype: _DType = ...) -> ulab.numpy.ndarray:
    """
    .. param: shape
...
def linspace(start: _float, stop: _float, *, dtype: _DType = ..., num: int = ..., endpoint: _bool = ..., retstep: _bool = ...) -> ulab.numpy.ndarray:
    """
    .. param: start
...
def logspace(start: _float, stop: _float, *, dtype: _DType = ..., num: int = ..., endpoint: _bool = ..., base: _float = ...) -> ulab.numpy.ndarray:
    """
    .. param: start
      First value in the array
    .. param: stop
...
def ones(shape: Union[int, Tuple[int, ...]], *, dtype: _DType = ...) -> ulab.numpy.ndarray:
    """
    .. param: shape
       Shape of the array, either an integer (for a 1-D array) or a tuple of 2 integers (for a 2-D array)
    .. param: dtype
...
def zeros(shape: Union[int, Tuple[int, ...]], *, dtype: _DType = ...) -> ulab.numpy.ndarray:
    """
    .. param: shape
       Shape of the array, either an integer (for a 1-D array) or a tuple of 2 integers (for a 2-D array)
    .. param: dtype
...
def argsort(array: ulab.numpy.ndarray, *, axis: int = ...) -> ulab.numpy.ndarray:
...
def diff(array: ulab.numpy.ndarray, *, n: int = ..., axis: int = ...) -> ulab.numpy.ndarray:
    """Return the numerical derivative of successive elements of the array, as
    an array.  axis=None is not supported."""
    ...

def flip(array: ulab.numpy.ndarray, *, axis: Optional[int] = ...) -> ulab.numpy.ndarray:
    """Returns a new array that reverses the order of the elements along the
    given axis, or along all axes if axis is None."""
    ...

def max(array: _ArrayLike, *, axis: Optional[int] = ...) -> _float:
    """Return the maximum element of the 1D array"""
    ...

def mean(array: _ArrayLike, *, axis: Optional[int] = ...) -> _float:
    """Return the mean element of the 1D array, as a number if axis is None, otherwise as an array."""
    ...

def median(array: ulab.numpy.ndarray, *, axis: int = ...) -> ulab.numpy.ndarray:
    """Find the median value in an array along the given axis, or along all axes if axis is None."""
    ...

def min(array: _ArrayLike, *, axis: Optional[int] = ...) -> _float:
    """Return the minimum element of the 1D array"""
    ...

def roll(array: ulab.numpy.ndarray, distance: int, *, axis: Optional[int] = ...) -> None:
    """Shift the content of a vector by the positions given as the second
    argument. If the ``axis`` keyword is supplied, the shift is applied to
    the given axis.  The array is modified in place."""
    ...

def sort(array: ulab.numpy.ndarray, *, axis: int = ...) -> ulab.numpy.ndarray:
    """Sort the array along the given axis, or along all axes if axis is None.
    The array is modified in place."""
    ...

def std(array: _ArrayLike, *, axis: Optional[int] = ..., ddof: int = ...) -> _float:
    """Return the standard deviation of the array, as a number if axis is None, otherwise as an array."""
    ...

def sum(array: _ArrayLike, *, axis: Optional[int] = ...) -> Union[_float, int, ulab.numpy.ndarray]:
...
def array(values: Union[ndarray, Iterable[Union[_float, _bool, Iterable[Any]]]], *, dtype: _DType = ...) -> ulab.numpy.ndarray:
...
def around(a: ulab.numpy.ndarray, *, decimals: int = ...) -> ulab.numpy.ndarray:
...
def vectorize(f: Union[Callable[[int], _float], Callable[[_float], _float]], *, otypes: Optional[_DType] = ...) -> Callable[[_ScalarOrArrayLike], ulab.numpy.ndarray]:
    """
