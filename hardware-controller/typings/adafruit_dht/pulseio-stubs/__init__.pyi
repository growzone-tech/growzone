...
class PulseIn:
    ...
    def __init__(self, pin: microcontroller.Pin, maxlen: int = ..., *, idle_state: bool = ...) -> None:
    ...
    def resume(self, trigger_duration: int = ...) -> None:
...
class PulseOut:
    ...
    def __init__(self, pin: microcontroller.Pin, *, frequency: int = ..., duty_cycle: int = ...) -> None:
