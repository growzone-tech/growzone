...
class RGBMatrix:
    ...
    def __init__(self, *, width: int, bit_depth: int, rgb_pins: Sequence[digitalio.DigitalInOut], addr_pins: Sequence[digitalio.DigitalInOut], clock_pin: digitalio.DigitalInOut, latch_pin: digitalio.DigitalInOut, output_enable_pin: digitalio.DigitalInOut, doublebuffer: bool = ..., framebuffer: Optional[WriteableBuffer] = ..., height: int = ..., tile: int = ..., serpentine: bool = ...) -> None:
